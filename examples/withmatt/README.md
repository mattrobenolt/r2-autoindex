...
This is the live kitchen-sink deployment for `r2-serve`:
...
```text
Worker: r2-serve-example
Bucket: r2-serve-example-withmatt-com
Queue:  r2-serve-example-events
Domain: r2-serve-example.withmatt.com
```
